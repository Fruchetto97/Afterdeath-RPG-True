...
try:
    ...
    load_pygame = None
from Overworld_Menu_V0 import PauseMenu, show_pause_menu
...
def run_object_script(obj):
    ...
    if norm_name == "prompt_albero_dorsale":
        # Display a message about the tree
        message_display.show_message("This tree is made out of backbones...", 3500)
        return True
    else:
        # Default debug print for unhandled objects
...
try:
    ...
    bone_grass_sound.set_volume(0.05)
...
while True:
        ...
        if event.type == pygame.QUIT:
            ...
            if event.key == pygame.K_F11:
                if screen.get_flags() & pygame.FULLSCREEN:
                    ...
                    # Enter fullscreen: use current display size
    ...
    damage = 0
    base_damage = 0.02 if is_running else 0.01
    if on_bone_grass:
        ...
        stack_multiplier = min(200.0, 1.0 * (1.015 ** (player.bone_grass_steps - 1)))
        if is_moving:
