...
class Config_Data:
    NAME = "Foresta Dorsale Est"
    MAP_NAME = "foresta_dorsale_est"  # Used for save/load system
    TMX_PATH = r"C:\Users\franc\Desktop\Afterdeath_RPG\Overworld\Mappe\Exports\Foresta_Dorsale_02.tmx"
